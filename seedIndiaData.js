...
const indiaData = {
    ...
    "Gujarat": ["Ahmedabad", "Surat", "Vadodara", "Rajkot", "Bhavnagar", "Jamnagar", "Junagadh", "Gandhinagar", "Nadiad", "Morbi", "Anand", "Bharuch", "Navsari", "Valsad", "Vapi", "Palanpur", "Mehsana", "Patan", "Bhuj", "Gandhidham", "Porbandar", "Veraval", "Botad", "Surendranagar", "Wadhwan", "Dahod", "Godhra", "Modasa", "Himmatnagar", "Kalol", "Kapadvanj", "Kheda", "Mahuva", "Mangrol", "Mundra", "Palitana", "Pardi", "Radhanpur", "Sidhpur", "Unjha", "Visnagar", "Vyara", "Ankleshwar", "Bardoli", "Bilimora", "Chikhli", "Dhoraji", "Gondal", "Jetpur", "Keshod", "Kutiyana", "Limbdi", "Lunawada", "Mandvi", "Mangalpur", "Mansa", "Mithapur", "Modasa", "Naroda", "Navsari", "Padra", "Palanpur", "Pardi", "Petlad", "Radhanpur", "Ranpur", "Sachin", "Sanand", "Sidhpur", "Sihor", "Songadh", "Talaja", "Thangadh", "Tharad", "Umbergaon", "Una", "Vadnagar", "Valsad", "Vanthali", "Vejalpur", "Vijapur", "Wankaner", "Zalod"],
